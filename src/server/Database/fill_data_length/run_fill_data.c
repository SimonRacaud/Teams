...
static bool run_fill_private_msg(user_t *user,
...
static bool run_fill_reply(thread_t *thread,
    bin_header_t *dest, database_save_t *db_save)
{
    reply_t *reply = NULL;
...
static bool run_fill_thread(channel_t *channel,
    bin_header_t *dest, database_save_t *db_save)
{
...
static bool run_fill_channel(team_t *team,
    bin_header_t *dest, database_save_t *db_save)
{
