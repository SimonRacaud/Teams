...
extern "C"
{
    ...
    extern void uuid_generate_md5(
        uuid_t out, const uuid_t ns, const char *name, size_t len);
    extern void uuid_generate_sha1(
        uuid_t out, const uuid_t ns, const char *name, size_t len);
    ...
    extern int uuid_parse_range(
        const char *in_start, const char *in_end, uuid_t uu);
